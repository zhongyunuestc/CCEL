...
public class Redict extends Thread{
	  ...
	  public Redict(List<String>rellist,Wikipedia wiki,List<String>bylist){
		  this.relist=rellist;
		  this.wiki=wiki;
		  this.bylist=bylist;
	  }
...
//			}
	  ...
	  public void relate() throws InterruptedException{
		  OperatorWiki op=new OperatorWiki();
		  Redict thread1=new Redict(relist,wiki,bylist);
		  Redict thread2=new Redict(relist,wiki,bylist);
		  Redict thread3=new Redict(relist,wiki,bylist);
		  Redict thread4=new Redict(relist,wiki,bylist);
...
//			thread8.join();
	   ...
	   public static void main(String[] args) throws InterruptedException {
		 ...
		 //  System.out.println(mw.name);
		   ...
		   Redict mr=new Redict(rellist,wiki,rellist1);
