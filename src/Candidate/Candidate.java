...
public class Candidate {
 ...
 public List<String>getCandidate(Wikipedia wiki,String name){
	 Page page=null;
	...
	// System.out.println(op.exist(wiki, name));
	 /*
	  * 当不存在该实体页面时，使用did you mean 纠正，该功能可以关闭
	  */
		 ...
		 if(flag&&flag1){
			 ...
			 for(Page outLinkPage:page.getOutlinks()){
	 		     ...
	 		     if((outLinkPage.getTitle().toString().contains(name)&&!outLinkPage.getTitle().toString().contains(" (disambiguation)"))
	 		    		|| sim.ld(outLinkPage.getTitle().toString(), name)<8){
		...
		//   System.out.println("name:"+name);
		 ...
		 if(op.isDisambigute(wiki,name)){
			 ...
			 for(Page outLinkPage:page.getOutlinks()){
	 		     ...
	 		     else if(((outLinkPage.getTitle().toString().contains(name)||Inconsistent(name,outLinkPage.getTitle().toString()))&&!outLinkPage.getTitle().toString().contains(" (disambiguation)")
	 		    		 &&!outLinkPage.getTitle().toString().contains("(genus)")&&!outLinkPage.getTitle().toString().contains("List of")
	 		    		 )||sim.ld(outLinkPage.getTitle().toString(), name)<5||isContainPoint(name,outLinkPage.getTitle().toString())){
	 		    	 String cannode="<"+name+","+outLinkPage.getTitle().toString()+">";
	 		    	    canlist.add(cannode); 
			 		   ...
			 		   if(name.length()<4&&!outLinkPage.getTitle().toString().contains(" (disambiguation)")
			 			&&isAbbreviation(name, outLinkPage.getTitle().toString())&&!outLinkPage.getTitle().toString().contains("List of")){
			 		     String cannode="<"+name+","+outLinkPage.getTitle().toString()+">";
		 		    		...
		 		    		&&!outLinkPage.getTitle().toString().contains("(genus)")&&!outLinkPage.getTitle().toString().contains("List of"))|| sim.ld(outLinkPage.getTitle().toString(), name)<4
				...
				for(Page outLinkPage:page1.getOutlinks()){
				   try {
				 	  if(!outLinkPage.getTitle().toString().contains("Surname")&&!outLinkPage.getTitle().toString().contains(" (disambiguation)")
				 			  ...
				 			  !outLinkPage.getTitle().toString().contains("List of")&&(outLinkPage.getTitle().toString().contains(name)||sim.ld(outLinkPage.getTitle().toString(), name)<3||Inconsistent(name,outLinkPage.getTitle().toString()))
				 			 ||isContainPoint(name,outLinkPage.getTitle().toString())){
...
//			 		     }//end if list of
	 ...
	 // System.out.println(canlist.contains("<"+name+","+name+" (surname)>"));
	  if(canlist.contains("<"+name+","+name+" (surname)>")){
		 ...
		 for(Page outLinkPage:page1.getOutlinks()){
	 		     try {
	 		     if((outLinkPage.getTitle().toString().contains(name)||Inconsistent(name,outLinkPage.getTitle().toString()))&&!outLinkPage.getTitle().toString().contains(" (disambiguation)")&&
...
//			 		     }//end if list of
 ...
 public static void main(String[] args) {
	...
	//	String name="Barack";
		List<String>list=Arrays.asList("Radwanska");
